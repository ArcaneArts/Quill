...
public class Configurator {
     ...
     * restrictions)
     *
     * @param object the object representing this config
     ...
     * @param object the object representing this config
     * @param file   the file
     * @throws IOException              file crap
     * @throws IllegalArgumentException reflection crap
     ...
     * @throws FileNotFoundException         the file doesnt exist or is something other than a file
     * @throws IOException                   more file crap
     * @throws InvalidConfigurationException your yaml is yack, not to be confused with yack, which is
     *                                       probably some language now.
     * @throws IllegalArgumentException      reflection crap
     * @throws IllegalAccessException        shouldnt happen (probably)
     */
     ...
     *
     * @param fc     the file config
     * @param object the object
     * @throws IllegalArgumentException shouldnt happen unless you are doing dumb crap like player
     *                                  variables without keydefs
     * @throws IllegalAccessException   really shouldnt happen
     */
     ...
     * @throws IllegalArgumentException  shoudlnt happen unless you are doing dumb shit.
     * @throws IllegalAccessException    shouldnt happen
     * @throws SecurityException         yeah...
